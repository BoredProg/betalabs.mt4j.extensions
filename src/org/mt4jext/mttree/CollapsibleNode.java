...
public class CollapsibleNode extends Node
{
    ...
    /**
     * This method will take the given node, and replace it with a
     * CollapsibleNode.
     *
     * It will detach the given Node's parent and children and give these to the
     * returned CollapsibleNode.
     * The CollapsibleNode will also assume the given Node's Object and
     * Component.
     *
     ...
     *
     * @return true if the node is hidden by collapse, false if it is hidden by
     *         itself or not hidden
     */
     ...
     *
     * This will cause any non-hidden children to hide, and any children that
     * are
     * added in the future will be hidden as well.
     * When "show()" is called on a child, it will remain hidden until
     * "expand()" is
     * called.
     */
    public void collapse()
    {
        ...
        {
            if (!(in instanceof CollapsibleNode))
            {
                continue;
            }
     ...
     * however, it does mark the node to be shown when the parent expands or
     * when
