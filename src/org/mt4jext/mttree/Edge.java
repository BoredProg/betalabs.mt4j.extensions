...
public class Edge
{
     ...
     * Note that this is called from update, and from any movement of connected
     * nodes.
     *
     * Any application that moves Node components outside of the framework
     * should call
     ...
     *
     * @return the Tree this Edge is a part of, or null if this Edge is not part
     *         of any Tree
     */
    Tree getTree()
    {
