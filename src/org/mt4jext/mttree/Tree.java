...
public class Tree
{
    ...
    /*
     * The update system will keep track whether a modification is needed or
     * not.
    ...
    public void setRoot(Node newRoot)
    {
        if (root == null)
        {
            if (!newRoot.isChild())
            {
                ...
                {
                    throw new RuntimeException("Cannot set root. Given node is already part of a tree.");
                }
            } else
            {
                throw new RuntimeException("Cannot set root. Given node is a child.");
            }
        } else
        {
            throw new RuntimeException("Cannot set root. This tree already has a root.");
        }
    }
     ...
     *
     * @return the TreeScene instance this Tree is attached to, or null if there
     *         is none
     */
     ...
     *
     * This method is to be called after structural changes to the Tree are
     * done.
     *
     ...
     *
     * Applications can generate or modify a Tree structure, but the changes are
     * not
     * complete until this method is called.
     * This is done to prevent the framework from internally calling update
     * routines
    ...
    private void nodePlaceReverseCursion(Node in)
    {
        ...
        {
            nodePlaceReverseCursion(in.getParent());
        }
