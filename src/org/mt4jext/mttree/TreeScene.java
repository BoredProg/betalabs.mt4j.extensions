...
public class TreeScene extends AbstractScene
{
     ...
     * (non-Javadoc)
     * @see
     * org.mt4j.sceneManagement.AbstractScene#drawAndUpdate(processing.core.PGraphics,
     * long)
     */
     ...
     * If you want to add a different kind of component, use
     * addChild(MTComponent).
     *
     ...
     *
     * This generates a simple MTLine of 0px (aka 1px regardless of
     * transformation).
     *
