...
public class MTCircularMenuBehaviour
{
    ...
    private IGestureEventListener[] segmentSelectionActions = new IGestureEventListener[]
    {
        new DefaultSegmentSelectionVisualisationAction()
    };

    private Class<? extends IInputProcessor> triggerProcessor = DragProcessor.class;
    private Class<? extends TriggerAction>[] triggerActionClasses = new Class[]
    {
        DefaultTriggerAction.class
    };
