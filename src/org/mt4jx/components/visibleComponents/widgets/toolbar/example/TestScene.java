...
public class TestScene extends AbstractScene {
	...
	public TestScene(MTApplication mtApplication, String name) {
		...
		final MTToolbarButton tbb2 = new MTToolbarButton(app.loadImage(imagePath + "iPhoto-icon.png"), app);
		final MTToolbarButton tbb3 = new MTToolbarButton(app.loadImage(imagePath + "iPhoto-icon.png"), app);
...
//		final MTToolbarButton submenuButton1 = new MTToolbarButton(app.loadImage(imagePath + "Text-Edit-icon.png"), app);
		final MTToolbarButton submenuButton2 = new MTToolbarButton(app.loadImage(imagePath + "iPhoto-icon.png"), app);
		final MTToolbarButton submenuButton3 = new MTToolbarButton(app.loadImage(imagePath + "Address-Book-icon.png"), app);
