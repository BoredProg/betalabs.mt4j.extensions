...
public abstract class AbstractDnDAction implements IGestureEventListener
{
    ...
    protected DropTarget detectDropTarget(MTGestureEvent g, boolean pickableObjectsOnly)
    {
        ...
        {
            final MTCanvas parentCanvas = getParentCanvas(sourceComponent);
            final PickResult prCanvas = parentCanvas.pick(componentDropPositions
            ...
            for (int i = 0; i < pickList.size(); i++)
            {
                ...
                final PickEntry currentPickEntry = pickList.get(i);
                final MTComponent currentComponent = currentPickEntry.hitObj;
