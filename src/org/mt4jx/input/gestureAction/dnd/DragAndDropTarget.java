...
public interface DragAndDropTarget extends DropTarget
{
    ...
    /**
     * Is called by DragAndDropAction, when a component is dragged above the
     * MTDropTarget.
     *
    ...
    /**
     * Is called by DragAndDropAction, when a component is dragged away from
     * above the MTDropTarget.
     *
